...
@Configuration
@PropertySource("classpath:com/markany/mysite/config/web/properties/fileupload.properties")
public class FileUploadConfig extends WebMvcConfigurerAdapter {
	...
	public MultipartResolver commonsMultipartResolver() {
		...
		/* 이렇게도 할수잇음!
		multipartResolver.setMaxUploadSize(100*1024*1024*5);
		multipartResolver.setMaxUploadSizePerFile(100*1024*1024); // file당 최대 size
		 */
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry
			.addResourceHandler(env.getProperty("fileupload.resourceHandler"))
